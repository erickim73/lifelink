...
export default function MainChat() {
    ...
    return (
        <div className={`flex-1 h-screen flex flex-col items-center justify-center transition-all duration-300 ${
                ...
                <form onSubmit={handleSubmit} className="w-full">
                    <div className="flex items-center gap-3 bg-zinc-900 rounded-full px-4 py-3 shadow-lg border border-zinc-700">
                        <textarea
                            ...
                            rows={1}
                            className="flex-1 bg-transparent outline-none text-white placeholder-gray-400 py-3 resize-none w-full"
                            style={{
                                minHeight: '50px',
                                maxHeight: '300px',
                                overflowY: 'auto',
